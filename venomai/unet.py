...
class UNet(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Compute loss
        loss = metrics.mcc_ce_loss(y_hat, y, w, axes=[0,2,3])
    ...
    def test_step(self, batch, batch_idx):
        ...
        # Log metrics to wandb
        self._log_metrics(self.test_metric_label, loss, y_hat, y, w)
            
    def set_test_metric_label(self, test_metric_label):
        self.test_metric_label = test_metric_label