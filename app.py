...
if __name__ == '__main__':
    ...
    st.text('1. Click on each lesion in the image to be analyzed. There should be a single white dot on each lesion you want analyzed.')
    st.text('2. Press the compute button below to calculate the average necrosis score for the selected lesions. Individiual lesion scores are also displayed.')
